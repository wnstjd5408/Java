...
//			System.out.println("파일을 불러왔습니다");
	...
	public void student_score_load() {  //로그인 정보 파일 불러오기 Load method
	    ...
	    try {
			...
			while(sc.hasNext()) {
				Student_score se = new Student_score(sc.next(), sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt(), sc.nextInt());
...
//			System.out.println("파일을 불러왔습니다");
	...
	public Student login() { //login method
		System.out.println("=======================");
...
//		System.out.println("아이디랑 ,비밀번호를 다시입력해주세요!!!")	
	 }
	...
	public void student_score_save() {//학생 점수 정보 파일 한줄씩 저장 메서드  추가 save method
		...
		String result = st.getId() + " " + st.getKor() + " " + st.getMath() + " " + st.getEng() + " " + st.getSci() + " " +  st.getHis() + "\n"; 
		out.print(result);
		out.close();
	}catch(IOException e) {
	...
	public void save() {//로그인 정보 파일 한줄씩 저장 메서드  추가 save method
		...
		String result = s.getName() + " " + s.getId() + " "
				+ s.getPwd() + " " + s.getAddress() + " " + s.getAge() +"\n";
		out.print(result);
		out.close();
	}catch(IOException e) {
		System.out.println("파일 오류");
